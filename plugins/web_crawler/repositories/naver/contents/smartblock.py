...
PLAYWRIGHT_VIEWPORT = {"width": 1080, "height": 1920}
...
HEADER_TITLE_SELECTORS = ("[data-sds-comp='Header']",)
...
class SmartBlockContents(TargetContents):
    ...
    async def _collect_keyword(self, context, keyword: str) -> list[SmartBlockRow]:
        ...
        try:
            ...
            return _parse_smartblock_rows(keyword, html, page.url, self.max_rows)
        except Exception:
